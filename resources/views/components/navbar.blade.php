        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/home" :current="request()->is('home')">Home</x-nav-link>
              <x-nav-link href="/about" :current="request()->is('about')">About</x-nav-link>
              <x-nav-link href="/projek" :current="request()->is('projek')">Projek</x-nav-link>
              <x-nav-link href="/blog" :current="request()->is('blog')">Page</x-nav-link>
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
        <x-nav-link href="/home" :current="request()->is('home')" class="block">Home</x-nav-link>
        <x-nav-link href="/about" :current="request()->is('about')" class="block">About</x-nav-link>
        <x-nav-link href="/projek" :current="request()->is('projek')" class="block">Projek</x-nav-link>
        <x-nav-link href="/blog" :current="request()->is('blog')" class="block">Page</x-nav-link>
        <x-nav-link href="/reports" :current="request()->is('reports')" class="block">Reports</x-nav-link>
      </div>
